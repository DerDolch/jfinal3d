...
public class TF3D_Mesh
{
                  ...
                  Vector3f & InvBinormal, Vector3f & InvTangent) 
  {
              //Calculate the vectors from the current vertex to the two other vertices in the triangle 
                ...
                // ROUNDOFF here is a macro that sets a value to 0.0f if the value is a very small value, such as > -0.001f and < 0.001. 
                ...
                {            
                        ...
                        /* Time to calculate the tangent, binormal, and normal. Look at Søren’s article for more information. 
                        Vector3f T, B, N;
                        ...
                        N = T%B; //Cross product!
  //This is where programmers should break up the function to smooth the tangent, binormal and normal values.
