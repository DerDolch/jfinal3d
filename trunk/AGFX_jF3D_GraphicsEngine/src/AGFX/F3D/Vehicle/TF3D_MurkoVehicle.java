 ...
 * 
 */
public class TF3D_MurkoVehicle extends TF3D_Entity
{
	 ...
	 */
	// -----------------------------------------------------------------------
	public TF3D_MurkoVehicle(String name)
	{
	...
	public void Create()
	{
		...
		localTrans.origin.set(0, 0.2f, 0f);
