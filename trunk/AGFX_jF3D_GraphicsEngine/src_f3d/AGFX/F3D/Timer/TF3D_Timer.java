...
public class TF3D_Timer
{
	...
	public void Update()
	{
		...
		} else
		{
			...
			// to ensure a minimum time granularity for coehsive movement even
			// in low frame rate
			// conditions
	...
	{
		return new String("Current FPS : " + realFPS + " Last Second FPS : " + secondFPS + " Average FPS : " + averageFPS + "");
	}
